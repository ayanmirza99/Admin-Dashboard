...
const SalesCard = ({ data }) => {
    return (
        <section className='h-full w-full overflow-x-hidden overflow-y-auto flex flex-col gap-2'>
            {data.map((d, index) => {
                return (
                    <div className='flex justify-between items-center p-2 text-[0.8rem] md:text-[1rem]' key={index}>
                        <div className='flex gap-4 items-center'>
                            <div className='rounded-full md:w-12 md:h-12 w-10 h-10 object-cover object-center'>
